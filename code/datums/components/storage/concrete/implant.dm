/datum/storage/concrete/implant
...
/datum/storage/concrete/implant/Initialize()
	. = ..()
	set_holdable(null, list(/obj/item/disk/nuclear))

/datum/storage/concrete/implant/InheritComponent(datum/storage/concrete/implant/I, original)
	if(!istype(I))
		return ..()
