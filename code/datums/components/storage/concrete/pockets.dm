...
/datum/storage/concrete/pockets/small/fedora/Initialize()
	. = ..()
...
/datum/storage/concrete/pockets/small/fedora/detective
	attack_hand_interact = TRUE // so the detectives would discover pockets in their hats

/datum/storage/concrete/pockets/chefhat
	attack_hand_interact = TRUE
	max_items = 1
	max_w_class = WEIGHT_CLASS_NORMAL

/datum/storage/concrete/pockets/chefhat/Initialize()
	. = ..()
	set_holdable(list(
...
/datum/storage/concrete/pockets/chefhat/can_be_inserted(obj/item/I, stop_messages, mob/M)
	. = ..()
...
/datum/storage/concrete/pockets/shoes/Initialize()
	. = ..()
	set_holdable(list(
...
/datum/storage/concrete/pockets/shoes/clown/Initialize()
	. = ..()
	set_holdable(list(
		/obj/item/knife, /obj/item/switchblade, /obj/item/pen,
		/obj/item/scalpel, /obj/item/reagent_containers/syringe, /obj/item/dnainjector,
...
/datum/storage/concrete/pockets/pocketprotector
	max_items = 3
	max_w_class = WEIGHT_CLASS_TINY
	var/atom/original_parent

/datum/storage/concrete/pockets/pocketprotector/Initialize()
...
/datum/storage/concrete/pockets/pocketprotector/real_location()
	// if the component is reparented to a jumpsuit, the items still go in the protector
	return original_parent

/datum/storage/concrete/pockets/helmet
	quickdraw = TRUE
	max_combined_w_class = 6

/datum/storage/concrete/pockets/helmet/Initialize()
	. = ..()
...
/datum/storage/concrete/pockets/void_cloak
	quickdraw = TRUE
	max_items = 3

/datum/storage/concrete/pockets/void_cloak/Initialize()
	. = ..()
