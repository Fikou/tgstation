...
/datum/status_effect/syphon_mark
	...
	var/obj/item/pka_modkit/bounty/reward_target

/datum/status_effect/syphon_mark/on_creation(mob/living/new_owner, obj/item/pka_modkit/bounty/new_reward_target)
	. = ..()
	if(.)
