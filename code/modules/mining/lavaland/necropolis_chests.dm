...
/obj/item/dragons_blood/attack_self(mob/living/carbon/human/user)
	...
	to_chat(H, "<span class='danger'>The power of the dragon's blood surges through you! You transform into a humanoid Ash Drake, immune to ash storms and lava, and you can unleash your full power and turn into a lesser Ash Drake.</span>")
