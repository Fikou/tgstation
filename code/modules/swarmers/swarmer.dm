...
/mob/living/simple_animal/hostile/swarmer
	...
	hud_type = /datum/hud/swarmer/standard
	...
	///Beacon the swarmer was born from
	var/obj/structure/swarmer_beacon/origin_beacon
...
/mob/living/simple_animal/hostile/swarmer/proc/Fabricate(atom/fabrication_object,fabrication_cost = 0)
	...
	if(resources < fabrication_cost)
		...
		return
	adjust_resources(-fabrication_cost)
...
/mob/living/simple_animal/hostile/swarmer/proc/Integrate(obj/target)
	...
	if(!resource_gain)
		...
		return FALSE
	adjust_resources(resource_gain)
	if(origin_beacon)
		origin_beacon.resources += resource_gain
...
/mob/living/simple_animal/hostile/swarmer/update_health_hud()
	if(hud_used)
		hud_used.healths.maptext = MAPTEXT("<div align='center' valign='middle' style='position:relative; top:0px; left:6px'><font color='#03fcef'>[health]/[maxHealth]</font></div>")

/mob/living/simple_animal/hostile/swarmer/proc/adjust_resources(resource)
	resources += resource
	updateResourceDisplay()

/mob/living/simple_animal/hostile/swarmer/proc/updateResourceDisplay()
	if(hud_used)
		hud_used.swarmer_resource_display.maptext = MAPTEXT("<div align='center' valign='middle' style='position:relative; top:0px; left:6px'><font color='#03fcef'>[resources]/[max_resources]</font></div>")
